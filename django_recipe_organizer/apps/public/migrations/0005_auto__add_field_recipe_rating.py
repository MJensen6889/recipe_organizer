...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'public_recipe', 'rating',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'public_recipe', 'rating')
    ...
    models = {
        ...
        u'public.recipe': {
            ...
            'instructions': ('django.db.models.fields.TextField', [], {'default': "'No instructions have been added yet.'"}),
